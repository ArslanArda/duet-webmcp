...
export function ChordTrack() {
  const { project, locale, editorMode, setHumanChord, setSelection, clearRange, activeTrack, completeOnboarding, selection } = useProjectStore();
